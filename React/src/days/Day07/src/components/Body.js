  ...
  const fetchData = async () => {
    try {
      const data = await fetch(
        "https://corsproxy.io/https://www.swiggy.com/dapi/restaurants/list/v5?lat=28.4249623&lng=77.3378599&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING"
      );
